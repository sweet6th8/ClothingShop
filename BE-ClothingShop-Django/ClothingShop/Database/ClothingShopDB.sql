...
VALUES (
    ...
    (
        ...
        'uần jean  nam với chất vải THOÁNG MÁT,  VẬN ĐỘNG THOẢI MÁI cho mùa hè nắng nóng. ' 'Bề mặt đanh, mịn, mặc thoả mái và vẫn giữ nguyên form quần sau nhiều lần giặt.' ' Đặc biệt form dáng rộng mát HOT nhất hè năm 2024',
        899000,
        70,
        1,
        1
    ...
    (
        ...
        The Jean luôn nỗ lực trở thành đơn vị cung cấp các mẫu Jean tốt nhất trên thị trường, với mẫu mã đa dạng' ' và luôn bắt kịp các xu hướng mới nhất.',
        500000,
        100,
        1,
        1
    ...
    (
        ...
        'Áo Thun TOMMY ',
        'ao-thun-nam-polo',
        'Áo thun nam là trang phục cơ bản và tiện dụng nhất đối với phái mạnh. Hầu như người đàn ông nào cũng' ' đều phải có vài chiếc áo pull nam trong tủ áo của mình. ',
        95000,
        300,
        1,
        3
    ...
    (
        ...
        'ao-thun-nam-tay-lo',
        'Dù là ai, bạn cũng nên thử nghĩ đến áo thun tay lỡ – một items mới mẻ mang đến style năng động và “chất lừ” cho bất cứ ai sở hữu nó.' ' Không phải áo thun freesize hay tay dài nữa' ', áo thun tay lỡ mới thực sự làm điên đảo giới trẻ trong thời điểm này.',
        85000,
        250,
        1,
        3
    ...
    (
        ...
        'Áo sơ mi trơn công sở là một kiểu áo sơ mi nam đơn giản, trang trọng và lịch sự' ', được thiết kế để mặc trong môi trường văn phòng hoặc các sự kiện chuyên nghiệp.',
        890000,
        30,
        1,
        4
...
- Đường may kỹ, tinh tế, sản phẩm luôn được kiểm tra kỹ lưỡng trước khi đóng gói.',
    ...
    (
        ...
        'u điểm của chất liệu này là bề mặt vải bóng mượt, mềm mịn, khả năng co giãn tốt. ' 'Vải Nylon spandex rất dễ giặt, độ bền cao, giữ form tốt,' ' không bị mất đi tính năng ban đầu và mang đến sự thoải mái cho người mặc',
        150000,
        452,
        2,
        2
...
VALUES (
        101,
        'product_images/quan_jean_nam_G_Jeans_a.jpg'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        101,
        'product_images/quan_jean_nam_G_Jeans_b.jpg'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        102,
        'product_images/quan_jean_nam_wash_retro_a.jpg'
    ),
    (
        102,
        'product_images/quan_jean_nam_wash_retro_b.jpg'
    ),
    (
        102,
        'product_images/quan_jean_nam_wash_retro_c.jpg'
    );
INSERT INTO ProductImage (product_id, image)
...
VALUES (
        104,
        'product_images/quan_jean_nam_cap_chun_a.jpg'
    ),
    (
        104,
        'product_images/quan_jean_nam_cap_chun_b.jpg'
    ),
    (
        104,
        'product_images/quan_jean_nam_cap_chun_c.jpg'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        105,
        'product_images/quan_jean_nam_tui_hop_a.jpg'
    ),
    (
        105,
        'product_images/quan_jean_nam_tui_hop_b.jpg'
    ),
    (
        105,
        'product_images/quan_jean_nam_tui_hop_c.jpg'
    );
INSERT INTO ProductImage (product_id, image)
...
VALUES (
        111,
        'product_images/quan_kaki_nam_Gen_Viet_a.jpg'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        111,
        'product_images/quan_kaki_nam_Gen_Viet_b.jpg'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        112,
        'product_images/quan_kaki_nam_cao_cap_a.jpg'
    ),
    (
        112,
        'product_images/quan_kaki_nam_cao_cap_b.jpg'
    ),
    (
        112,
        'product_images/quan_kaki_nam_cao_cap_c.jpg'
    );
INSERT INTO ProductImage (product_id, image)
...
VALUES (
        114,
        'product_images/quan_kaki_nam_tui_hop_a.jpg'
    ),
    (
        114,
        'product_images/quan_kaki_nam_tui_hop_b.jpg'
    ),
    (
        114,
        'product_images/quan_kaki_nam_tui_hop_c.jpg'
    );
INSERT INTO ProductImage (product_id, image)
...
VALUES (
        116,
        'product_images/quan_kaki_nam_FABUMAN_a.jpg'
    ),
    (
        116,
        'product_images/quan_kaki_nam_FABUMAN_b.jpg'
    ),
    (
        116,
        'product_images/quan_kaki_nam_FABUMAN_c.jpg'
    );
...
VALUES (
        132,
        'product_images/ao_so_mi_nam_Pastel_Premium_a.jpg'
    ),
    (
        132,
        'product_images/ao_so_mi_nam_Pastel_Premium_b.jpg'
    ),
    (
        132,
        'product_images/ao_so_mi_nam_Pastel_Premium_c.jpg'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        133,
        'product_images/ao_so_mi_nam_tay_ngan_a.jpg'
    ),
    (
        133,
        'product_images/ao_so_mi_nam_tay_ngan_b.jpg'
    ),
    (
        133,
        'product_images/ao_so_mi_nam_tay_ngan_c.jpg'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        134,
        'product_images/ao_so_mi_JAMINE_HOUSE_a.jpg'
    ),
    (
        134,
        'product_images/ao_so_mi_JAMINE_HOUSE_b.jpg'
    ),
    (
        134,
        'product_images/ao_so_mi_JAMINE_HOUSE_c.jpg'
    );
INSERT INTO ProductImage (product_id, image)
...
VALUES (
        136,
        'product_images/ao_so_mi_nam_Tianlesiwei_a.jpg'
    ),
    (
        136,
        'product_images/ao_so_mi_nam_Tianlesiwei_b.jpg'
    ),
    (
        136,
        'product_images/ao_so_mi_nam_Tianlesiwei_c.jpg'
    );
-- Ảnh cho Áo Khoác Nam (3 ảnh)
INSERT INTO ProductImage (product_id, image)
VALUES (
        141,
        'product_images/ao_khoac_gio_BAD_HABITS_a.jpg'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        141,
        'product_images/ao_khoac_gio_BAD_HABITS_b.jpg'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        141,
        'product_images/ao_khoac_gio_BAD_HABITS_c.jpg'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        141,
        'product_images/ao_khoac_gio_BAD_HABITS_d.jpg'
    );
INSERT INTO ProductImage (product_id, image)
...
VALUES (
        144,
        'product_images/ao_khoac_Hoodie_Academy_a.jpg'
    ),
    (
        144,
        'product_images/ao_khoac_Hoodie_Academy_b.jpg'
    ),
    (
        144,
        'product_images/ao_khoac_Hoodie_Academy_c.jpg'
    );
INSERT INTO ProductImage (product_id, image)
...
VALUES (
        151,
        'product_images/quan_short_nam_BAD_HABITS_a.jpg'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        151,
        'product_images/quan_short_nam_BAD_HABITS_b.jpg'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        151,
        'product_images/quan_short_nam_BAD_HABITS_c.jpg'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        151,
        'product_images/quan_short_nam_BAD_HABITS_d.jpg'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        152,
        'product_images/quan_short_tui_hop_nam_a.jpg'
    ),
    (
        152,
        'product_images/quan_short_tui_hop_nam_b.jpg'
    ),
    (
        152,
        'product_images/quan_short_tui_hop_nam_c.jpg'
    ),
    (
        152,
        'product_images/quan_short_tui_hop_nam_d.jpg'
    ),
    (
        152,
        'product_images/quan_short_tui_hop_nam_e.jpg'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        153,
        'product_images/quan_short_JOGGER_nam_a.jpg'
    ),
    (
        153,
        'product_images/quan_short_JOGGER_nam_b.jpg'
    );
INSERT INTO ProductImage (product_id, image)
...
VALUES (
        202,
        'product_images/quan_jean_SUNAIXUE_nu_a.jpg'
    ),
    (
        202,
        'product_images/quan_jean_SUNAIXUE_nu_b.jpg'
    ),
    (
        202,
        'product_images/quan_jean_SUNAIXUE_nu_c.jpg'
    );
INSERT INTO ProductImage (product_id, image)
...
VALUES (
        205,
        'product_images/quan_jean_Sinransinya_a.jpg'
    ),
    (
        205,
        'product_images/quan_jean_Sinransinya_b.jpg'
    ),
    (
        205,
        'product_images/quan_jean_Sinransinya_c.jpg'
    );
INSERT INTO ProductImage (product_id, image)
...
VALUES (
        211,
        'product_images/quan_legging_nu_uniqlo_a.jpg'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        211,
        'product_images/quan_legging_nu_uniqlo_b.jpg'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        212,
        'product_images/quan_legging_ECOCHIC_nu_a.jpg'
    ),
    (
        212,
        'product_images/quan_legging_ECOCHIC_nu_b.jpg'
    ),
    (
        212,
        'product_images/quan_legging_ECOCHIC_nu_c.jpg'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        213,
        'product_images/quan_legging_Fitme_Zeta_nu_a.jpg'
    ),
    (
        213,
        'product_images/quan_legging_Fitme_Zeta_nu_b.jpg'
    );
INSERT INTO ProductImage (product_id, image)
...
VALUES (
        224,
        'product_images/ao_thun_nu_Calvin_Klein_a.jpg'
    ),
    (
        224,
        'product_images/ao_thun_nu_Calvin_Klein_b.jpg'
    ),
    (
        224,
        'product_images/ao_thun_nu_Calvin_Klein_c.jpg'
    );
INSERT INTO ProductImage (product_id, image)
...
VALUES (
        242,
        'product_images/ao_len_nu_micro_flare_a.jpg'
    ),
    (
        242,
        'product_images/ao_len_nu_micro_flare_b.jpg'
    ),
    (
        242,
        'product_images/ao_len_nu_micro_flare_c.jpg'
    );
INSERT INTO ProductImage (product_id, image)
...
VALUES (
        301,
        'product_images/quan_jean_tre_em_uniqlo_a.jpg'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        301,
...
VALUES (
        302,
        'product_images/quan_jean_tre_em_babimama_a.jpg'
    ),
    (
        302,
        'product_images/quan_jean_tre_em_babimama_b.jpg'
    ),
    (
        302,
        'product_images/quan_jean_tre_em_babimama_c.jpg'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        303,
        'product_images/quan_jean_tre_em_tiingxuyu_a.jpg'
    ),
    (
        303,
        'product_images/quan_jean_tre_em_tiingxuyu_b.jpg'
    ),
    (
        303,
        'product_images/quan_jean_tre_em_tiingxuyu_c.jpg'
    );
-- Ảnh cho Quần Short Trẻ Em (2 ảnh)
INSERT INTO ProductImage (product_id, image)
VALUES (
        311,
        'product_images/quan_short_tre_em_uniqlo_a.jpg'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        311,
        'product_images/quan_short_tre_em_uniqlo_b.jpg'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        311,
        'product_images/quan_short_tre_em_uniqlo_c.jpg'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        311,
        'product_images/quan_short_tre_em_uniqlo_d.jpg'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        312,
        'product_images/quan_short_tre_em_bobdog_a.jpg'
    ),
    (
        312,
        'product_images/quan_short_tre_em_bobdog_b.jpg'
    ),
    (
        312,
        'product_images/quan_short_tre_em_bobdog_c.jpg'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        313,
        'product_images/quan_short_tre_em_babyloveGo_a.jpg'
    ),
    (
        313,
        'product_images/quan_short_tre_em_babyloveGo_b.jpg'
    ),
    (
        313,
        'product_images/quan_short_tre_em_babyloveGo_c.jpg'
    );
-- Ảnh cho Áo Thun Trẻ Em (4 ảnh)
INSERT INTO ProductImage (product_id, image)
VALUES (
        321,
        'product_images/ao_thun_tre_em_uniqlo_a.jpg'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        321,
        'product_images/ao_thun_tre_em_uniqlo_b.jpg'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        321,
        'product_images/ao_thun_tre_em_uniqlo_c.jpg'
    );
INSERT INTO ProductImage (product_id, image)
...
VALUES (
        331,
        'product_images/ao_so_mi_tre_em_uniqlo_a.jpg'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        331,
        'product_images/ao_so_mi_tre_em_uniqlo_b.jpg'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        332,
        'product_images/ao_so_mi_tre_em_BERNIE_kids_a.jpg'
    ),
    (
        332,
        'product_images/ao_so_mi_tre_em_BERNIE_kids_b.jpg'
    ),
    (
        332,
        'product_images/ao_so_mi_tre_em_BERNIE_kids_c.jpg'
    );
INSERT INTO ProductImage (product_id, image)
...
VALUES (
        341,
        'product_images/ao_khoac_tre_em_uniqlo_a.jpg'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        341,
        'product_images/ao_khoac_tre_em_uniqlo_b.jpg'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        341,
        'product_images/ao_khoac_tre_em_uniqlo_c.jpg'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        342,
        'product_images/ao_khoac_tre_em_Capy_Bara_a.jpg'
    ),
    (
        342,
        'product_images/ao_khoac_tre_em_Capy_Bara_b.jpg'
    ),
    (
        342,
        'product_images/ao_khoac_tre_em_Capy_Bara_c.jpg'
    );
INSERT INTO ProductImage (product_id, image)
...
VALUES (
        352,
        'product_images/vay_nu_tre_em_im_kids_a.jpg'
    ),
    (
        352,
        'product_images/vay_nu_tre_em_im_kids_b.jpg'
    ),
    (
        352,
        'product_images/vay_nu_tre_em_im_kids_c.jpg'
    );
INSERT INTO ProductImage (product_id, image)
