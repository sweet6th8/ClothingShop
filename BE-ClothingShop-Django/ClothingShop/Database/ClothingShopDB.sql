...
- Đường may kỹ, tinh tế, sản phẩm luôn được kiểm tra kỹ lưỡng trước khi đóng gói.',
    ...
    (
        ...
        'ao-thun-slim-fit-nu',
        'Áo Đỏ Năm Mới Giáng Sinh Slim Fit Cổ Tròn cực kì sang chảnh,' ' thời thượng giúp các nàng có những bộ ảnh đi chơi, du lịch xinh xắn',
        170000,
        260,
        2,
        3
...
VALUES (
        101,
        'product_images/quan_jean_nam_G_Jeans_a.png'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        101,
        'product_images/quan_jean_nam_G_Jeans_b.png'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        102,
        'product_images/quan_jean_nam_wash_retro_a.png'
    ),
    (
        102,
        'product_images/quan_jean_nam_wash_retro_b.png'
    ),
    (
        102,
        'product_images/quan_jean_nam_wash_retro_c.png'
    );
INSERT INTO ProductImage (product_id, image)
...
VALUES (
        111,
        'product_images/quan_kaki_nam_Gen_Viet_a.png'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        111,
        'product_images/quan_kaki_nam_Gen_Viet_b.png'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        112,
        'product_images/quan_kaki_nam_cao_cap_a.png'
    ),
    (
        112,
        'product_images/quan_kaki_nam_cao_cap_b.png'
    ),
    (
        112,
        'product_images/quan_kaki_nam_cao_cap_c.png'
    );
INSERT INTO ProductImage (product_id, image)
...
VALUES (
        132,
        'product_images/ao_so_mi_nam_Pastel_Premium_a.png'
    ),
    (
        132,
        'product_images/ao_so_mi_nam_Pastel_Premium_b.png'
    ),
    (
        132,
        'product_images/ao_so_mi_nam_Pastel_Premium_c.png'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        133,
        'product_images/ao_so_mi_nam_tay_ngan_a.png'
    ),
    (
        133,
        'product_images/ao_so_mi_nam_tay_ngan_b.png'
    ),
    (
        133,
        'product_images/ao_so_mi_nam_tay_ngan_c.png'
    );
-- Ảnh cho Áo Khoác Nam (3 ảnh)
INSERT INTO ProductImage (product_id, image)
VALUES (
        141,
        'product_images/ao_khoac_gio_BAD_HABITS_a.png'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        141,
        'product_images/ao_khoac_gio_BAD_HABITS_b.png'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        141,
        'product_images/ao_khoac_gio_BAD_HABITS_c.png'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        141,
        'product_images/ao_khoac_gio_BAD_HABITS_d.png'
    );
INSERT INTO ProductImage (product_id, image)
...
VALUES (
        151,
        'product_images/quan_short_nam_BAD_HABITS_a.png'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        151,
        'product_images/quan_short_nam_BAD_HABITS_b.png'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        151,
        'product_images/quan_short_nam_BAD_HABITS_c.png'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        151,
        'product_images/quan_short_nam_BAD_HABITS_d.png'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        152,
        'product_images/quan_short_tui_hop_nam_a.png'
    ),
    (
        152,
        'product_images/quan_short_tui_hop_nam_b.png'
    ),
    (
        152,
        'product_images/quan_short_tui_hop_nam_c.png'
    ),
    (
        152,
        'product_images/quan_short_tui_hop_nam_d.png'
    ),
    (
        152,
        'product_images/quan_short_tui_hop_nam_e.png'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        153,
        'product_images/quan_short_JOGGER_nam_a.png'
    ),
    (
        153,
        'product_images/quan_short_JOGGER_nam_b.png'
    );
...
VALUES (
        202,
        'product_images/quan_jean_SUNAIXUE_nu_a.png'
    ),
    (
        202,
        'product_images/quan_jean_SUNAIXUE_nu_b.png'
    ),
    (
        202,
        'product_images/quan_jean_SUNAIXUE_nu_c.png'
    );
INSERT INTO ProductImage (product_id, image)
...
VALUES (
        211,
        'product_images/quan_legging_nu_uniqlo_a.png'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        211,
        'product_images/quan_legging_nu_uniqlo_b.png'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        212,
        'product_images/quan_legging_ECOCHIC_nu_a.png'
    ),
    (
        212,
        'product_images/quan_legging_ECOCHIC_nu_b.png'
    ),
    (
        212,
        'product_images/quan_legging_ECOCHIC_nu_c.png'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        213,
        'product_images/quan_legging_Fitme_Zeta_nu_a.png'
    ),
    (
        213,
        'product_images/quan_legging_Fitme_Zeta_nu_b.png'
    );
...
VALUES (
        301,
        'product_images/quan_jean_tre_em_uniqlo_a.png'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        301,
...
VALUES (
        311,
        'product_images/quan_short_tre_em_uniqlo_a.png'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        311,
        'product_images/quan_short_tre_em_uniqlo_b.png'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        311,
        'product_images/quan_short_tre_em_uniqlo_c.png'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        311,
        'product_images/quan_short_tre_em_uniqlo_d.png'
    );
-- Ảnh cho Áo Thun Trẻ Em (4 ảnh)
INSERT INTO ProductImage (product_id, image)
VALUES (
        321,
        'product_images/ao_thun_tre_em_uniqlo_a.png'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        321,
        'product_images/ao_thun_tre_em_uniqlo_b.png'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        321,
        'product_images/ao_thun_tre_em_uniqlo_c.png'
    );
-- Ảnh cho Áo Sơ Mi Trẻ Em (2 ảnh)
INSERT INTO ProductImage (product_id, image)
VALUES (
        331,
        'product_images/ao_so_mi_tre_em_uniqlo_a.png'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        331,
        'product_images/ao_so_mi_tre_em_uniqlo_b.png'
    );
-- Ảnh cho Áo Khoác Trẻ Em (3 ảnh)
INSERT INTO ProductImage (product_id, image)
VALUES (
        341,
        'product_images/ao_khoac_tre_em_uniqlo_a.png'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        341,
        'product_images/ao_khoac_tre_em_uniqlo_b.png'
    );
INSERT INTO ProductImage (product_id, image)
VALUES (
        341,
        'product_images/ao_khoac_tre_em_uniqlo_c.png'
    );
